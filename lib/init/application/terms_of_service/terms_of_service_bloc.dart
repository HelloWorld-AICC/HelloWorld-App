...
@injectable
class TermsOfServiceBloc extends Bloc<TermsOfServiceEvent, TermsOfServiceSate> {
  ...
  TermsOfServiceBloc({required this.communityRepository, required this.bus})
      : super(TermsOfServiceSate.initial()) {
